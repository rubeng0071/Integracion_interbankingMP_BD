...
BEGIN
    CREATE TABLE finance.mp_payments (
        ...
        notification_url            NVARCHAR(500) NULL,
        statement_descriptor        NVARCHAR(255) NULL,
...
BEGIN
    CREATE TABLE finance.ib_movements (
        ...
        depositor_code              NVARCHAR(100) NULL,
        operation_code_ib           NVARCHAR(20) NULL,
        operation_code_bank         NVARCHAR(20) NULL,
        code_description_ib         NVARCHAR(255) NULL,
        customer_cuit               NVARCHAR(20) NULL,
        depositor_description       NVARCHAR(255) NULL,
        code_description_bank       NVARCHAR(255) NULL,
...
BEGIN
    CREATE TABLE finance.ib_transfers (
        ...
        transfer_type_description       NVARCHAR(255) NULL,
        account_label                   NVARCHAR(255) NULL,
        amount                          DECIMAL(18,2) NULL,
        currency                        NVARCHAR(10) NULL,
        ...
        addenda                         NVARCHAR(1000) NULL,
        transfer_comments               NVARCHAR(1000) NULL,
        ...
        credit_account_bank_name        NVARCHAR(100) NULL,
        credit_account_account_label    NVARCHAR(255) NULL,
        ...
        debit_account_bank_name         NVARCHAR(100) NULL,
        debit_account_account_label     NVARCHAR(255) NULL,
        raw_json                        NVARCHAR(MAX) NULL,
...
BEGIN
    CREATE TABLE finance.ib_vouchers (
        ...
        paying_customer                 NVARCHAR(255) NULL,
        debit_account_customer_cuit     NVARCHAR(20) NULL,
        debit_account_account_cbu       NVARCHAR(32) NULL,
        ...
        debit_account_bank_name         NVARCHAR(100) NULL,
        debit_account_account_label     NVARCHAR(255) NULL,
        afip_concept_description        NVARCHAR(255) NULL,
        afip_control_code               NVARCHAR(50) NULL,
        afip_nro_formulario             NVARCHAR(50) NULL,
        afip_tax_description            NVARCHAR(255) NULL,
        afip_fee_number                 NVARCHAR(50) NULL,
        afip_pago_desc                  NVARCHAR(255) NULL,
        afip_provider_name              NVARCHAR(255) NULL,
...
BEGIN
    CREATE TABLE finance.ib_extracts (
        ...
        correlative_number           NVARCHAR(50) NULL,
        source_account               NVARCHAR(50) NULL,
        code_description_standard    NVARCHAR(255) NULL,
